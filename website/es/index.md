...
features:
  ...
  - icon:
    ...
    title: Soporte CJK Considerado
    details: Por fin, un editor que entiende el 中文、日本語、한국어. Espaciado inteligente entre caracteres CJK y latinos, puntuación de ancho completo, comillas de esquina「como estas」. Veinte reglas de formato, un solo atajo.

  - icon:
      src: /icons/palette.svg
    title: Bellamente Diseñado
    details: Limpio cuando necesitas concentrarte. Potente cuando necesitas control. Cinco temas artesanales, tipografía que respeta tus fuentes, una barra de herramientas que aparece solo cuando la quieres.

  - icon:
      src: /icons/keyboard.svg
    title: Poder Sin Complejidad
    details: 165 atajos de teclado. Tres modos de edición — WYSIWYG, Vista Previa de Fuente y Fuente. Edición multicursor, modo enfoque, modo máquina de escribir, historial de documentos. Todo disponible cuando lo necesitas. Invisible cuando no.
---
...
Claude Code, Claude Desktop, Codex CLI, Gemini CLI... pueden escribir directamente en tus documentos mediante integración MCP:
...
[Aprende a configurar MCP →](/es/guide/mcp-setup)
...
<div class="credits-section">
  <div class="credits-row">
    <span class="credits-label">Productor</span>
  ...
  <div class="credits-row">
    <span class="credits-label">Programadores</span>
