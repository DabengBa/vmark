...
features:
  - icon:
      src: /icons/bot.svg
    title: AI 친화적
    details: AI 시대를 위해 만들어졌습니다. VMark는 MCP를 기본으로 지원합니다 — Claude, Codex, Gemini가 문서를 읽고, 제안하고, 편집할 수 있습니다. 플러그인이 필요 없습니다. 그냥 연결하고 협업하세요.

  - icon:
      src: /icons/languages.svg
    title: CJK 혼용을 고려한 설계
    details: 드디어 中文、日本語、한국어를 이해하는 에디터가 등장했습니다. 스마트한 CJK-라틴 간격 조정, 전각 문장 부호, 모서리 따옴표「이런 것들」. 스무 가지 서식 규칙, 단축키 하나면 끝.

  - icon:
      src: /icons/palette.svg
    title: 아름다운 디자인
    details: 집중이 필요할 때는 깔끔하게. 제어가 필요할 때는 강력하게. 다섯 가지 정성껏 만든 테마, 폰트를 존중하는 타이포그래피, 원할 때만 나타나는 툴바.
...
<div class="screenshots-grid">
  <div class="screenshot-card">
    <img src="/screenshots/sending-from-claude-code.png" alt="Claude Code CLI에서 콘텐츠 전송" loading="lazy" />
    <div class="caption">Claude Code에게 VMark에 직접 문서를 생성하도록 요청하세요</div>
  </div>
  <div class="screenshot-card">
    <img src="/screenshots/sending-from-claude-desktop.png" alt="Claude Desktop에서 콘텐츠 전송" loading="lazy" />
    <div class="caption">또는 동일한 프롬프트로 Claude Desktop을 사용하세요</div>
  </div>
  <div class="screenshot-card">
    <img src="/screenshots/content-received-by-vmark.png" alt="VMark에서 수신한 콘텐츠" loading="lazy" />
    <div class="caption">콘텐츠가 완전한 서식으로 VMark에 나타납니다</div>
  </div>
</div>
</div>

[MCP 설정 방법 알아보기 →](/ko/guide/mcp-setup)
...
<div class="screenshots-grid">
  <div class="screenshot-card">
    <img src="/screenshots/editor-main.png" alt="VMark 리치 텍스트 에디터" loading="lazy" />
    <div class="caption">WYSIWYG 모드</div>
  </div>
  <div class="screenshot-card">
    <img src="/screenshots/source-mode.png" alt="VMark 소스 모드" loading="lazy" />
    <div class="caption">소스 모드 (F6)</div>
  </div>
  <div class="screenshot-card">
    <img src="/screenshots/dark-theme.png" alt="VMark 나이트 테마" loading="lazy" />
    <div class="caption">나이트 테마</div>
  </div>
</div>
</div>
...
[VMark 받기 →](/ko/download)

## 크레딧

<div class="credits-section">
  <div class="credits-row">
    <span class="credits-label">프로듀서</span>
  ...
  <div class="credits-row">
    <span class="credits-label">코더</span>
