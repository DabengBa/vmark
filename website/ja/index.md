...
features:
  ...
  - icon:
    ...
    title: CJKテキストへの配慮
    details: ついに、中文、日本語、한국어を理解するエディタが登場しました。スマートなCJK-Latin間のスペーシング、全角句読点、角括弧「このような」。20のフォーマットルール、1つのショートカット。

  - icon:
      src: /icons/palette.svg
    title: 美しいデザイン
    details: 集中が必要なときはクリーンに。コントロールが必要なときはパワフルに。5つの手作りテーマ、フォントを尊重するタイポグラフィ、必要なときだけ表示されるツールバー。
...
Claude Code、Claude Desktop、Codex CLI、Gemini CLI... はMCP連携を通じてドキュメントに直接書き込むことができます：
...
[MCPのセットアップ方法を学ぶ →](/ja/guide/mcp-setup)
...
VMarkはmacOS向けに最適化されており、Apple SiliconとIntelの両方をネイティブサポートしています。最新バージョンをダウンロードして今すぐ執筆を始めましょう。
