...
VMark exposes **12 composite tools** and **4 resources**. Each tool uses an `action` parameter to select the operation — this reduces token overhead while keeping all capabilities accessible.
